const checkCatalogQuery=`select id from dbo.catalog where name=$1 and sellerid=$2;`;
...
module.exports={createCatalogQuery,createProductQuery,getSellerIDQuery,ordersQuery,checkCatalogQuery};